...
mem_addr=["200c", "2008","2000","2004","201c","2020","2008","2028","200c","2008","2000","2004","201c","2020","2008","2028","2308"]
...
if (user_input=='a'):
    ...
    for i in range (len(mem_addr)):
        ...
        if (valid_bit== 0):                                                     #empty block(miss)
            ...
            for i in range(16):                                                 #updating Cache
                Cache[(set_index*16)+i]= (hex(int(addr_from,16) +i))            #will add mem[] to load from memory
    ...
    print("Hit rate: " + str(DM_rate))
        ...
        for i in range (len(mem_addr)):
            ...
            print("Memory accessed: M[ " + addr_from + " - " + addr_to+" ]" )
            print("Bringing into block " + str(block_index) + " of the cache\n")
            print("cache: "+ str(Cache)+"\n")
